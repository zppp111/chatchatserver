...
bool Redis::publish(int channel, string message)
{
    ...
    if (nullptr == reply)
    {
        LOG_ERROR << "publish [" << channel <<message.c_str()<< "] error!";
        //cerr << "publish command failed!" << endl;
        return false;
    }
    freeReplyObject(reply);
    //cout << "publish command success!" << endl;
    LOG_ERROR << "publish [" << channel <<message.c_str()<< "] success!";
    return true;
}
...
bool Redis::unsubscribe(int channel)
{
    ...
    {
        LOG_ERROR<< "unsubscribe command failed!==>"  << "unsubscribe [" << channel << "] error!";
    ...
    LOG_INFO << "unsubscribe command success!==>" << "unsubscribe [" << channel << "] success!";
    return true;
}
